...
# BB#9:                                 # %for.body_copy_copy
	...
	subl	%ecx, %edx
	je	.LBB0_3
# BB#10:                                # %if.else_copy_copy
                                        #   in Loop: Header=BB0_1 Depth=1
	addl	$5, %ebx
	addl	$2, %eax
	cmpl	$30000, %eax            # imm = 0x7530
	jg	.LBB0_19
# BB#11:                                # %for.body_copy17
                                        #   in Loop: Header=BB0_1 Depth=1
	addl	%eax, %ebx
	movslq	%ebx, %rcx
	imulq	$1717986919, %rcx, %rcx # imm = 0x66666667
	...
	subl	%ecx, %edx
	je	.LBB0_3
# BB#12:                                # %if.else_copy21
                                        #   in Loop: Header=BB0_1 Depth=1
	addl	$5, %ebx
	addl	$2, %eax
	cmpl	$30000, %eax            # imm = 0x7530
	jg	.LBB0_19
# BB#13:                                # %for.body_copy_copy28
                                        #   in Loop: Header=BB0_1 Depth=1
	addl	%eax, %ebx
	movslq	%ebx, %rcx
	imulq	$1717986919, %rcx, %rcx # imm = 0x66666667
	...
	subl	%ecx, %edx
	je	.LBB0_3
# BB#14:                                # %if.else_copy_copy32
                                        #   in Loop: Header=BB0_1 Depth=1
	addl	$5, %ebx
	addl	$2, %eax
	cmpl	$30000, %eax            # imm = 0x7530
	jg	.LBB0_19
# BB#15:                                # %for.body_copy6_copy
                                        #   in Loop: Header=BB0_1 Depth=1
	addl	%eax, %ebx
	movslq	%ebx, %rcx
	imulq	$1717986919, %rcx, %rcx # imm = 0x66666667
	...
	subl	%ecx, %edx
	je	.LBB0_3
# BB#16:                                # %if.else_copy10_copy
                                        #   in Loop: Header=BB0_1 Depth=1
	addl	$5, %ebx
	addl	$2, %eax
	cmpl	$30000, %eax            # imm = 0x7530
	jg	.LBB0_19
# BB#17:                                # %for.body_copy_copy_copy
                                        #   in Loop: Header=BB0_1 Depth=1
	addl	%eax, %ebx
	movslq	%ebx, %rcx
	imulq	$1717986919, %rcx, %rcx # imm = 0x66666667
